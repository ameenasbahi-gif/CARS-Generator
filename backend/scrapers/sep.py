...
ENTRIES_BY_TOPIC = {
    "philosophy": [
        ...
        "functionalism", "physicalism", "dualism", "intentionality",
        "belief", "action", "rationality", "epistemology",
        "skepticism", "a-priori-justification", "analytic-synthetic",
        "teleology", "mereology", "time", "identity",
        "possible-worlds", "abstract-objects", "platonism-mathematics",
    ...
    "ethics": [
        ...
        "moral-psychology", "moral-motivation", "desert",
        "rights", "liberty", "property-rights", "contractualism",
        "moral-luck", "moral-relativism", "supererogation",
        "animal-cognition", "future-generations",
        "distributive-justice", "privacy", "paternalism",
    ],
    "social science": [
        "democracy", "race", "disability", "identity-personal",
        "scientific-explanation", "science-theory-observation",
        "social-epistemology", "collective-intentionality",
        "punishment", "legitimacy", "multiculturalism",
        "toleration", "nationalism", "colonialism",
        "gender", "class-social", "poverty",
        "education-philosophy", "language-social",
    ],
    "natural science": [
        "science-theory-observation", "scientific-explanation",
        "naturalism", "reductionism", "causation-metaphysics",
        "emergence", "scientific-progress", "scientific-realism",
        "confirmation", "innateness-language",
        "evolution", "laws-of-nature", "biology-philosophy",
        "neuroscience-philosophy", "cognitive-science",
        "models-science", "thought-experiments",
    ],
    "humanities": [
        "beauty", "art-definition", "death", "memory", "emotion",
        "perception", "language-thought", "meaning",
        "fiction", "imagination", "aesthetic-judgment",
        "expression-arts", "art-authenticity", "literature",
        "music", "narrative", "creativity", "interpretation-art",
        "tragedy", "humor", "ambiguity",
    ],
}
